<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutUs.aspx.cs" Inherits="TheQueensRestaurantsCafe_.AboutUs" %>
    ...
    <div class="page text-center"><a class="banner banner-top" href="" target="_blank"></a>
      ...
      <footer class="section-relative section-top-66 section-bottom-34 page-footer bg-gray-base context-dark">
        ...
        <div class="container offset-top-50">
          <p class="small text-darker"><span>&copy;&nbsp;</span><span class="copyright-year"></span><span>&nbsp;</span><span>The Queens Restaurant & Cafe</span>. All Rights Reserved. Design by Aateka Vohra and Mansi Patel</p>
        </div>
      </footer>
    </div>
